...
urlpatterns = [
    ...
    path("loans/<int:loan_id>/pdf/", download_loan_pdf, name="download_loan_pdf"),
    ...
    path("users/permissions/", group_list, name="group_list"),
    path("users/permissions/create/", create_group, name="create_group"),
